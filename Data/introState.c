...
void IntroUpdate()
{
	...
	ClearScreen(IntroImageColour);
}

void IntroDraw(u64 colour)
{
#ifndef NOSMOKE_PLATFORM_SDL
	...
	DrawSpriteTexture(&IntroImage,0,  // X1
						0,  // Y2
						0.0f,  // U1
						0.0f,  // V1
